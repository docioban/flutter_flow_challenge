...
class NormalPlatform extends Platform<NormalPlatformState> {
  ...
  final Map<String, Vector2> spriteOprions = {
  ...
  @override
  Future<void>? onLoad() async {
    int randSpriteIndex = Random().nextInt(spriteOprions.length);

    String randSprite = spriteOprions.keys.elementAt(randSpriteIndex);
